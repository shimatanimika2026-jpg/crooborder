-- 修复 create_operation_exception 函数使用正确的枚举类型名称

DROP FUNCTION IF EXISTS create_operation_exception(TEXT, TEXT, TEXT, BIGINT, TEXT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, BIGINT, UUID, UUID, DATE, TEXT, TEXT, TEXT);
...
BEGIN
  ...
  INSERT INTO operation_exceptions (
    ...
    p_source_module::exception_source_module,
    p_source_record_id,
    p_related_sn,
    p_related_plan_id,
